...
function loadSortableListWithPagination (iPage, nbParPage)
{
	...
	ajaxZone.load (src, {zSortField:zSortField, zSortDirection:zSortDirection, iPage:iPage, iParPage:nbParPage}, function() {
			doOnLoad ($("div")) ;
		}) ;
}
...
$.fn.sortableListWithPagination = function () {
	$ (this).each (function() {
		...
		if(iNombreTotal > 1){
			ajoutSpan.append ("Total : " + iNombreTotal + " &eacute;l&eacute;ments");
		} else{
			ajoutSpan.append ("Total : " + iNombreTotal + " &eacute;l&eacute;ment");
		}
