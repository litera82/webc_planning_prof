...
* @subpackage commun
*/
class lightResponse extends jResponseHtml
{

    public $bodyTpl = 'light~layout' ;
    public $title	= 'Agenda - form2plus';
	...
	*/
	...
	{
		$this->body->assignZoneIfNone('header', 'light~header', array());
		$this->body->assignIfNone('content', '<p>no content</p>', array());
		$this->body->assignZoneIfNone('footer', 'light~footer', array());
    }
