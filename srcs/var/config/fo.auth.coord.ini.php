...
bad_ip_action = "jxauth~login:out"
...
;after_login = "jelix_calendar~FoCalendar:index";
after_login = "evenement~FoEvenement:getEventListing";

enable_after_logout_override = on
after_logout = "jauth~login:formFO"
