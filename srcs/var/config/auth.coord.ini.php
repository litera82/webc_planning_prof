...
; driver name : "Db", "Class" , "LDS"  or "nacl" (respect the case of characters)
driver = Db
...
after_login = "admin~administrateurs:index"
...
;------- parameters for the "nacl" driver
[nacl]
; name of the dao to get user data
dao = "nacl2~nacl_user"
...
; class name of user object record
class_name = "nacl_userRecord"
