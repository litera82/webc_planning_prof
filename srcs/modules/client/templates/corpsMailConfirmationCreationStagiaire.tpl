        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					Bienvenue sur le planning en ligne de Forma2+.<br /><br />
					Vous êtes inscrit(e) en tant que stagiaire. Vous pouvez maintenant visionner vos cours planifiés avec votre professeur <b>{$oUtilisateur->utilisateur_zNom} {$oUtilisateur->utilisateur_zPrenom}</b> en vous connectant sur : <a href="http://{$zUrlToIndexStagiaire}" target="_blank" style="text-decoration:none;color:#003399;">Planning en ligne/Forma2+</a><br /><br /><br />
					<ul>
						<li><b>Votre identifiant :</b> {$oClient->client_zLogin}</li>
						<li><b>Votre mot de passe :</b> {$oClient->client_zPass}</li>
					</ul>
					<br /><br /><br />
                </font>
            </p>
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					Nous vous souhaitons un agréable stage.
					<br /><br /><br /><br /><br /><br />
					A très bientôt,<br />
