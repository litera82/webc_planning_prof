...
class groupeSrv 
{
	...
	{
		$oFac = jDao::create('commun~groupe') ;
		return $oFac->get($_iId) ;
	}

	static function listCriteria($_toParams, $_zSortedField = 'groupe_id', $_zSortedDirection = 'ASC', $_iStart = 0, $_iOffset = 0) 
	{
		$zSql  = "" ;
		$zSql .= " SELECT DISTINCT SQL_CALC_FOUND_ROWS * FROM groupe " ;
		$zSql .= " WHERE 1 = 1 " ;
	...
	{		
		    $oDaoFact = jDao::get('commun~groupe') ;
            $oRecord = null;
