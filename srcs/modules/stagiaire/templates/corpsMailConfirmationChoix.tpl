        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					...
					{$zCivilite} {$oClient->client_zNom} {$oClient->client_zPrenom} a réservé une date non planifier pour son premier cours de stage.<br /><br /> 
				...
				<br /><br /><br />
				<font face="Verdana, Geneva, sans-serif" size="2">
					Ceci est un mail envoyé automatiquement depuis l'application webcalendar suite à une proposition de date d'un stagiaire pour son cours.
                </font>
				<br /><br /><br />
				<font face="Verdana, Geneva, sans-serif" size="2">
					Cordialement,<br />
