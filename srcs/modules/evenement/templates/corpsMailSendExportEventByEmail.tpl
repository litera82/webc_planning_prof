        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					Bonjour {$oProf->utilisateur_zPrenom} {$oProf->utilisateur_zNom}<br /><br /><br /><br /><br /><br />
					Veuillez trouver dans la pièce jointe de ce mail une copie au format Excel de votre planning sur Webcaledar.
                </font>
				<br /><br /><br /><br /><br /><br />
				<font face="Verdana, Geneva, sans-serif" size="2">
					Vous pouvez télécharger ce fichier <a href="http://{$zUrlToSite}userFiles/xls/eventToSendByMail/{$zExportsFullPath}" target="_blank" style="color:blue;">ici</a>
                </font>
