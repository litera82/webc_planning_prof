        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					Bonjour {$oClient->client_zPrenom} {$oClient->client_zNom}<br /><br /><br /><br /><br /><br />
					Veuillez trouver dans la pièce jointe de ce mail une copie au format Excel de vos prochains cours avec votre professeur {$oProf->utilisateur_zPrenom} {$oProf->utilisateur_zNom}. 
					<br /><br />Vous pouvez le (la) contacter à l'adresse <b>{$oProf->utilisateur_zMail}</b> ou par téléphone au numéro <b>{$oProf->utilisateur_zTel}</b>. 
                </font>
				<br /><br /><br /><br /><br />
				<font face="Verdana, Geneva, sans-serif" size="2">
					Vous pouvez <a href="http://{$zUrlToSite}userFiles/xls/eventToSendByMailStagiaire/{$zExportsFullPath}" target="_blank" style="color:blue;">télécharger le fichier ici.</a>
                </font>
				<br /><br /><br /><br /><br /><br /><br /><br />
				<font face="Verdana, Geneva, sans-serif" size="2">
					A très bientôt,<br />
					Equipe Planning en ligne/Forma2+
                </font>
            </p>
		</td>
    </tr>
